...
define('knockout', ko);
define('main',['durandal/system', 'durandal/app', 'durandal/viewLocator', 'repositories/userRepository'], function (system, app, viewLocator, userRepository) {
