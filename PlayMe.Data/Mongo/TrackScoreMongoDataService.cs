...
{
    public class TrackScoreMongoDataService : MongoDataService<MapReduceResult<TrackScore>>
    {
        public TrackScoreMongoDataService(ISharedCollection<QueuedTrack> queuedTrackDataService )
        {
